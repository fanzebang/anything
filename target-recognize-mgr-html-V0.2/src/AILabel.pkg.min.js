          ...
          case EFeatureType.Circle:
            {
              ...
              forEach_1(points, function (point, index) {
                ...
                if (distance <= 5) {
                  ...
                  if(point.width && point.width == 'rightCenter' ) _this11.map.setCursor("e-resize");
                  if(point.width && point.width == 'leftCenter' ) _this11.map.setCursor("w-resize");
                  if(point.height && point.height == 'topCenter' ) _this11.map.setCursor("n-resize");  //范修改
                  if(point.height && point.height == 'bottomCenter' ) _this11.map.setCursor("s-resize"); 
          ...
          case EFeatureType.Rect:
            {
              ...
              if (this.hoverFeature) {
                newRectShape = {
                  ...
                  var preNewWidth 
                  var preNewHeight 
                  // console.log(preNewWidth,preNewHeight)
                  // console.log(this.map.platformDom.style.cursor)
